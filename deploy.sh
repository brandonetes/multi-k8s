...
kubectl set image deployments/client-deployment client=brandonetes/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=brandonetes/multi-worker:$SHA
